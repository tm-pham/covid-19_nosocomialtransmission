...
# Data
pDshape <- 5                        # Shape for gamma distribution for dispersion parameter for transmission process
pDrate <- 0.5                       # Rate for gamma distribution for dispersion parameter for transmission process

pDshape_obs <- 5                    # Shape for gamma distribution for dispersion parameter for observation process
pDrate_obs <- 0.5                   # Rate for gamma distribution for dispersion parameter for observation process

fshape <- 5                         # Shape for gamma distribution for transmission parameters
